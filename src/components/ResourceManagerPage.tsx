    ...
    <div className="space-y-6 pb-12">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-md border border-[#D1D5DB] bg-white py-2 pl-10 pr-4 text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-600 sm:w-64"
            />
          </div>
          <button
            onClick={() => setIsCreateOpen(true)}
            className="flex items-center justify-center gap-2 rounded-md bg-blue-600 px-5 py-2 text-sm font-bold text-white shadow-sm hover:bg-blue-700"
          >
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        {[
          ...
          <div key={stat.label} className="rounded-md border border-[#E5E7EB] bg-white p-5">
      ...
      <div className="overflow-hidden rounded-md border border-[#E5E7EB] bg-white">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-16 text-center">
            ...
            <button
              onClick={() => setIsCreateOpen(true)}
              className="mt-6 rounded-md bg-[#111827] px-6 py-2.5 text-sm font-bold text-white hover:bg-black"
            >
              {createLabel}
            </button>
          </div>
      ...
      {isCreateOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4">
          <form onSubmit={createResource} className="w-full max-w-2xl overflow-hidden rounded-lg bg-white shadow-2xl">
            ...
            <div className="grid max-h-[70vh] grid-cols-1 gap-5 overflow-y-auto p-6 md:grid-cols-2">
              <label className="space-y-2 md:col-span-2">
                ...
                <input
                  ...
                  className="w-full rounded border border-gray-200 px-3 py-2 text-sm focus:border-blue-600 focus:outline-none"
                />
              </label>
              ...
              <label className="space-y-2 md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full rounded border border-gray-200 px-3 py-2 font-mono text-xs focus:border-blue-600 focus:outline-none"
                />
              </label>
            </div>
            <div className="flex items-center justify-end gap-3 border-t border-gray-100 px-6 py-4">
              <button type="button" onClick={() => setIsCreateOpen(false)} className="rounded border border-gray-200 px-4 py-2 text-sm font-bold text-gray-600 hover:bg-gray-50">
                Cancel
              </button>
              <button disabled={saving} className="flex items-center gap-2 rounded bg-blue-600 px-5 py-2 text-sm font-bold text-white hover:bg-blue-700 disabled:opacity-60">
