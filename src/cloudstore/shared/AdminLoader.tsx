...
export default function AdminLoader() {
  return (
    <div className="fixed inset-0 z-[9999] bg-white flex flex-col items-center justify-center min-h-screen min-w-[100vw]">
      <style>{`
        .loader-container {
          transform: scale(0.4);
          display: flex;
        ...
        @-webkit-keyframes ground-shine { 0%, 70% { opacity: 0; } 75%, 87% { opacity: 0.2; } 100% { opacity: 0; } }
