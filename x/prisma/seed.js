...
async function main() {
  ...
  const settings = [
    ...
    { scope: 'platform', scopeId: '', key: 'systemEmail', value: { host: '127.0.0.1', publicHost: 'mail.tiwlo.com', tlsServername: 'mail.tiwlo.com', port: 465, username: 'noreply', fromEmail: 'noreply@tiwlo.com', fromName: 'Tiwlo', replyTo: 'noreply@tiwlo.com', secureSSL: true, tlsRejectUnauthorized: false } },
  ...
  const adminModules = [
    ...
    ['admin.api', 'main-admin', 'API Management', '/management/api', 'API keys, scopes, webhooks, and rate limits.'],
