...
export const socialResolvers = {
  ...
  Query: {
    ...
    socialAdPlacements: (_, { placement, limit }, ctx) => api(service.listAdPlacements(ctx, placement, limit)),
    socialMyAds: (_, { status }, ctx) => api(service.listMyAds(ctx, status)),
    socialAdsSummary: (_, __, ctx) => api(service.adsSummary(ctx)),
    socialAdEligiblePosts: (_, { limit }, ctx) => api(service.listAdEligiblePosts(ctx, limit)),
    ...
    adminSocialAds: (_, { status }, ctx) => api(service.adminAds(ctx, status)),
  ...
  Mutation: {
    ...
    trackSocialAdEvent: (_, { input }, ctx) => api(service.trackAdEvent(ctx, input)),
    createSocialAdCampaign: (_, { input }, ctx) => api(service.createCreatorAdCampaign(ctx, input)),
    updateSocialAdCampaign: (_, { input }, ctx) => api(service.updateCreatorAdCampaign(ctx, input)),
    pauseSocialAdCampaign: (_, { id, paused }, ctx) => api(service.pauseCreatorAdCampaign(ctx, id, paused)),
    deleteSocialAdCampaign: (_, { id }, ctx) => service.deleteCreatorAdCampaign(ctx, id),
    adminUpsertSocialAd: (_, { input }, ctx) => api(service.adminUpsertAd(ctx, input)),
    adminDeleteSocialAd: (_, { id }, ctx) => service.adminDeleteAd(ctx, id),
